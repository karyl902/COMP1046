...
print("First card drawn:", deck.drawCard().toString()) 
deck.shuffle()
print("Shuffled card:", deck.drawCard().toString()) 
deck.reset()
print("Deck reset to size:", len(deck.cards))
deck.reset()
#Task3
class Hand:
    def __init__(self):
...
print("Hand cards:")
hand.showCards()
print("Hand value:", hand.getHandValue()) 
hand.emptyHand()
print("Hand value after empty:", hand.getHandValue()) 